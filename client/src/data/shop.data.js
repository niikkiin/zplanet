...
const SHOP_DATA = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 103,
        name: 'ElarZ Lechon De Leche',
        imageURL: product101,
        description: 'ElarZ Lechon De Leche  - Perfect for 15 - 25 PAX',
        price: 56,
      },
      {
        id: 104,
        name: 'ElarZ Lechon Large',
        imageURL: product101,
        description: 'ElarZ Lechon Large  - Perfect for 40 - 60 PAX',
        price: 48,
      },
      {
        id: 105,
        name: 'ElarZ Lechon Extra Large',
        imageURL: product101,
        description: 'ElarZ Lechon Extra Large  - Perfect for 50 - 70 PAX',
        price: 56,
      },
      {
        id: 106,
        name: 'ElarZ Lechon Double Extra Large',
        imageURL: product101,
        description: 'ElarZ Lechon Double Extra Large  - Perfect for 60 - 80 PAX',
        price: 56,
      },
      {
        id: 107,
        name: 'ElarZ Lechon Medium',
        imageURL: product101,
        description: 'ElarZ Lechon Medium  - Perfect for 30 - 50 PAX',
        price: 56,
      },
    ],
  },
